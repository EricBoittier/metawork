...
\toprule
                 Dataset  &  \makecell{\textsc{Lorem}$^{\dagger}$ \\{ $1\times$SR$+$LR}}  &  \makecell{\textsc{Cace-Les} \\{ $1\times$SR$+$LR}}  &  \makecell{\textsc{Mace} \\{ $2\times$SR}}  &  \makecell{\textsc{Pet} \\{ $2\times$ SR}}  &  \makecell{4G-NN \\{ $1\times$SR$+$LR}}  &  \makecell{\textsc{SpookyNet} \\{ $6\times$SR$+$LR}} \\ 
\midrule
