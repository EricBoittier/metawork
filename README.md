...
[`etc/lorem-parity/`](etc/lorem-parity/). Energy / force / dipole training
on the [PhysNet SN2 set](https://zenodo.org/records/2605341) is in
[`etc/sn2_zenodo/`](etc/sn2_zenodo/).
