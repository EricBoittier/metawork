...
# PET short-range trunk, initialized from PET-MAD-s:
...
| [`options/energy-forces-dipole-lorem-pet.yaml`](options/energy-forces-dipole-lorem-pet.yaml) | `mtt train` (PET short-range, PET-MAD-s init) |
